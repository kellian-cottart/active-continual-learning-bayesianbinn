...
File description: Classical MLP classifiers with different normalization layers
"""
...
class BaseMLP(Module):
    ...
    def __init__(self, key, layers=[784, 50, 10], use_bias=False, activation_fn=None, norm_fn=None, norm_params=None,  active_learning=None, **kwargs):
